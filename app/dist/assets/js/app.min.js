  ...
  $.ajax({
      ...
      success : function (data){
        ...
        if(data.username){
            ...
            $("span#idUser").text(data.username);
            var mapDiv = $("#map");
            mapDiv.css("width" , "80%");
            map.resize();
        }
...
$("a#inputHelp").click(function(){
    $("#map").hide();
  });
  
  $("a#inputHelp").click(function(){
    $('#presentationSite').removeClass("d-none");
}); 

  $("a#inputMap").click(function(){
    $("#map").show();
  });
  $("a#inputMap").click(function(){
    $("#presentationSite").addClass("d-none");
    ...
    var urlAPI = "http://localhost/velo-city6-master/api"
    var user;
...
$.ajax({
  ...
  if(response == 'ko'){
    ...
    alert("Félicitations " + user.username + " vous avez réservé, déverrouiller le vélo de votre choix");
